...
```shell
go get -u github.com/Rabbitcoccus/go-wallet-sdk/coins/filecoin
```
...
## License
Most packages or folder are [MIT](<https://github.com/Rabbitcoccus/go-wallet-sdk/blob/main/coins/filecoin/LICENSE>) licensed, see package or folder for the respective license.
