...
```shell
go get -u github.com/Rabbitcoccus/go-wallet-sdk/coins/oasis
```
...
## License
Most packages or folder are [MIT](<https://github.com/Rabbitcoccus/go-wallet-sdk/blob/main/coins/oasis/LICENSE>) licensed, see package or folder for the respective license.
