...
```shell
go get -u github.com/Rabbitcoccus/go-wallet-sdk/coins/ton
```
...
Most packages or folder are [MIT](<https://github.com/Rabbitcoccus/go-wallet-sdk/blob/main/coins/ton/LICENSE>) licensed, see
