...
```shell
go get -u github.com/Rabbitcoccus/go-wallet-sdk/coins/starknet
```
...
## License
Most packages or folder are [MIT](<https://github.com/Rabbitcoccus/go-wallet-sdk/blob/main/coins/starknet/LICENSE>) licensed, see package or folder for the respective license.
