...
```shell
go get -u github.com/Rabbitcoccus/go-wallet-sdk/coins/helium
```
...
## License
Most packages or folder are [MIT](<https://github.com/Rabbitcoccus/go-wallet-sdk/blob/main/coins/helium/LICENSE>) licensed, see package or folder for the respective license.
